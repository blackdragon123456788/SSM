	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/user/findAll.do?page=1&size=5">用户管理</a></li>
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新"
												onclick="location.href='${pageContext.request.contextPath}/user/findAll.do?page=1&size=5'">
								    ...
								    <c:forEach var="user" items="${pageInfo.list}">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/delUser.do?id=${user.id}" onclick="javascript: return del()" class="btn bg-olive btn-xs">删除</a>
					...
					<!-- /.box-body -->
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="${pageContext.request.contextPath}?page=${pageInfo.pages}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
